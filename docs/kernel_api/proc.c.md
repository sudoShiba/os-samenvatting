...
Dit bestand bevat de implementaties voor `kernel/proc.c`. Hieronder vind je de uitleg en de broncode van **elke functie** in dit bestand.
...
## `sleep()`
> Sleep on channel chan, releasing condition lock lk. Re-acquires lk when awakened.
