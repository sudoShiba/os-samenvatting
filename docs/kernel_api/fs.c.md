...
Dit bestand bevat de implementaties voor `kernel/fs.c`. Hieronder vind je de uitleg en de broncode van **elke functie** in dit bestand.
...
## `balloc()`
> Blocks. Allocate a zeroed disk block. returns 0 if out of disk space.
